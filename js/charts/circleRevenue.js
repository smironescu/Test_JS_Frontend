define(["../lib/d3", "drawCircle"], function (d3, drawCircle) {
    ...
    var drawCircleRevenue = function(percentage){
        ...
        var color = colors.getColor("green");
        var totalRevenue = "200.000€";

        var smartphonePercent = percentage / 100;
        var smartphoneTotalAmount = ((percentage * 2) * 1000).toLocaleString() + "€";
        var tabletPercent = 100 - smartphonePercent * 100;
        var tabletTotalAmount = (((100 - smartphonePercent * 100) * 2) * 1000).toLocaleString() + "€";
        ...
        var parent = d3.select('div#revenue--circle');
        ...
        var smartPhonePercentSelect = d3.select(".smartphone--percent--revenue");
        var smartPhoneTotalAmountSelect = d3.select(".smartphone--totalAmount--revenue");
        ...
        var tabletPercentSelect = d3.select(".tablet--percent--revenue");
        var tabletTotalAmountSelect = d3.select(".tablet--totalAmount--revenue");
