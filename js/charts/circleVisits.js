define(["../lib/d3", "drawCircle"], function (d3, drawCircle) {
    ...
    var drawCircleRevenue = function(percentage, color, secondaryColor){
        ...
        var parent = d3.select('div#visits--circle');
        ...
        var smartPhonePercentSelect = d3.select(".smartphone--percent--visits");
        var smartPhoneTotalAmountSelect = d3.select(".smartphone--totalAmount--visits");
        ...
        var tabletPercentSelect = d3.select(".tablet--percent--visits");
        var tabletTotalAmountSelect = d3.select(".tablet--totalAmount--visits");
